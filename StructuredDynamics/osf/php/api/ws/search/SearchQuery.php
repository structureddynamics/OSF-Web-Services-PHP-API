<?php
  ...
  */  
  class SearchQuery extends \StructuredDynamics\osf\php\api\framework\WebServiceQuery
  {
    ...
    * 
    */
    public function recordsLocationAggregator($lat, $long)
    {
      if(!isset($this->params["results_location_aggregator"]))
      {
        $this->params["results_location_aggregator"] = "";
      }
                 
      $this->params["results_location_aggregator"] .= $lat.','.$long;      
